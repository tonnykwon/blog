---
title: "Alternating Least Sqaures with Implicit Dataset"
date: 2020-03-10
...
ALS를 이용한 행렬 분해는 따라서 다음과 같은 특성을 갖는다.

- $$r_{ui}$$를 선호도 $$p_{ui}$$와 확신도 $$c_{ui}$$로 표현한다.

- $$n \cdot m$$ 유저와 아이템 조합에 대해 선형적으로 알고리즘을 계산한다.
